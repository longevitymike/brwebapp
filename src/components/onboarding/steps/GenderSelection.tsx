...
const genderOptions = ['Boy', 'Girl']; // Updated options
...
export default function GenderSelection({ onNext, name }: GenderSelectionProps) {
  const [selected, setSelected] = useState<string | null>(null);

  return (
    <div className="p-6 max-w-md mx-auto text-center">
      {/* Updated question using the name prop */}
      <h2 className="text-xl font-bold mb-4 text-gray-800">Cool, is {name || 'the athlete'} a boy or a girl?</h2>
